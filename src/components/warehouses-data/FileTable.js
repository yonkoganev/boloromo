  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await fetch(
        `${API_URL}/files?category=warehouse&filename=${encodeURIComponent(
          deleteTarget.name
        )}`,
        { method: "DELETE" }
      );
      ...
      showError(err.message || "Something went wrong while deleting the file.");
    }
  };
              ...
              <TableRow key={file.name}>
                ...
                <TableCell align="right">
                  ...
                  <IconButton
                    ...
                    onClick={() =>
                      window.open(
                        `${API_URL}/download?category=warehouse&filename=${encodeURIComponent(
                          file.name
                        )}`,
                        "_blank"
                      )
